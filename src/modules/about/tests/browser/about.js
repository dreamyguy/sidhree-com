module.exports = {
    "Section - About" : function (browser) {
        browser
            ...
            .verify.containsText("section.about .heading-one", "Wallace Sidhrée", "Section 'About' heading's has correct text")
            .verify.elementPresent("section.about .heading-three", "Section 'About' sub-heading is present")
            .verify.containsText("section.about .heading-three", "Frontend Developer", "Section 'About' heading's has correct text")
            ...
            .verify.urlEquals("https://github.com/dreamyguy/sidhree-com", "The correct URL was opened when clicking on the link -> https://github.com/dreamyguy/sidhree-com")
            .back()
    }
};
